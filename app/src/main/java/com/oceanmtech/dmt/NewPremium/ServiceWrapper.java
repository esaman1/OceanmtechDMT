...
import com.oceanmtech.dmt.BuildConfig;
import com.oceanmtech.dmt.PayU.Constantspayu;
...
public class ServiceWrapper {
    ...
    public Retrofit getRetrofit(Interceptor mInterceptorheader) {
        ...
        builder.connectTimeout(Constantspayu.API_CONNECTION_TIMEOUT, TimeUnit.SECONDS);
        builder.readTimeout(Constantspayu.API_READ_TIMEOUT, TimeUnit.SECONDS);
...
//            HttpLoggingInterceptor loggingInterceptor = new HttpLoggingInterceptor();
        ...
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(Constantspayu.BASE_URL)

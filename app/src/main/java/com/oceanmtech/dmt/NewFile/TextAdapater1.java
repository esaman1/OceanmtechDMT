...
import com.oceanmtech.dmt.Activity.Greetings_make_save_Activity;
import com.oceanmtech.dmt.R;


public class TextAdapater1 extends BaseAdapter {
    ...
    public TextAdapater1(Greetings_make_save_Activity thirtActivity) {

...
public class NewScaleGestureDetector {
    ...
    public interface OnScaleGestureListener {
        ...
        public void onScaleEnd(View view, NewScaleGestureDetector detector);
    }
    ...
    private NewVector2D mCurrSpanVector;
    ...
    public NewScaleGestureDetector(OnScaleGestureListener listener) {
        mListener = listener;
        mCurrSpanVector = new NewVector2D();
    }
    ...
    public NewVector2D getCurrentSpanVector() {
